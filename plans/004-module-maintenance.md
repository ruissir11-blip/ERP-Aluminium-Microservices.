...
- **Machine**: id, designation, brand, model, serial_number, purchase_date, acquisition_value, residual_value, workshop_id, status, created_at
- **MachineDocument**: id, machine_id, document_type, file_path, uploaded_at
- **MaintenancePlan**: id, machine_id, description, frequency, frequency_days, next_due_date, is_active
- **WorkOrder**: id, work_order_number, machine_id, type (preventive/corrective), status, priority, assigned_to, description, scheduled_date, actual_start, actual_end, labor_hours, labor_cost, total_cost, notes, created_by, created_at, closed_at
- **WorkOrderPart**: id, work_order_id, part_id, quantity, unit_cost
- **BreakdownRecord**: id, work_order_id, reported_at, response_time_minutes, repair_time_minutes, root_cause
