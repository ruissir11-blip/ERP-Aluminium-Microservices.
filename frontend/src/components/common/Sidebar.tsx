...
const mainMenuItems: MenuItem[] = [
  ...
  { path: '/invoices', icon: Receipt, label: 'Factures', requiredRoles: ['ADMIN', 'COMPTABLE', 'COMMERCIAL_RESPONSIBLE'] },
...
const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/maintenance/plans', icon: Calendar, label: 'Plans', requiredRoles: ['ADMIN', 'MAINTENANCE_RESPONSIBLE'] },
      { path: '/maintenance/calendar', icon: Calendar, label: 'Calendrier', requiredRoles: ['ADMIN', 'MAINTENANCE_RESPONSIBLE'] },
      { path: '/maintenance/metrics', icon: TrendingUp, label: 'Métriques', requiredRoles: ['ADMIN', 'MAINTENANCE_RESPONSIBLE'] },
      { path: '/maintenance/costs', icon: DollarSign, label: 'Coûts', requiredRoles: ['ADMIN', 'MAINTENANCE_RESPONSIBLE'] },
    ],
  },
  {
    id: 'ai',
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/comptabilite/commercial-performance', icon: TrendingUp, label: 'Performance Commerciale', requiredRoles: ['ADMIN', 'COMPTABLE'] },
      { path: '/comptabilite/customer-profitability', icon: Users, label: 'Rentabilité Client', requiredRoles: ['ADMIN', 'COMPTABLE'] },
      ...
      { path: '/comptabilite/cost-configuration', icon: Settings, label: 'Configuration Coûts', requiredRoles: ['ADMIN', 'COMPTABLE'] },
    ],
  },
  {
    id: 'hr',
    ...
    items: [
      ...
      { path: '/hr/employees', icon: Users, label: 'Employés', requiredRoles: ['ADMIN', 'RH_RESPONSIBLE'] },
      { path: '/hr/departments', icon: Building2, label: 'Départements', requiredRoles: ['ADMIN', 'RH_RESPONSIBLE'] },
